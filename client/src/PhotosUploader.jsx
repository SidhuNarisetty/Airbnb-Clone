...
export default function PhotosUploader({addedPhotos, onChange}){
    ...
    async function addPhotobyLink(eve){
        eve.preventDefault();
    ...
    async function uploadPhoto(eve){
        // eve.preventDefault();
    ...
    return (
        <>
            <div className="flex gap-2">
                <input type='text' value={photolink} onChange={eve => setPhotoLink(eve.target.value)} placeholder='Add using a link ......jpg'/>
                <button onClick={addPhotobyLink} className="bg-gray-200 px-4 rounded-2xl">Add&nbsp;photo</button>
            </div>
            <div className=" mt-2 grid grid-cols-3 md:grid-cols4 lg:grid-cols-6">
