    ...
    return (
        <header className='flex justify-between'>
          <Link to={'/'} href='' className='flex items-center gap-1'>
            ...
            <span className='font_bold text-xl'>airbnb</span>
          </Link>
          <div className='flex gap-2 border-gray-300 rounded-full py-1 px-4 shadow-md shadow-gray-300'>
            <div>Any Where</div>
            <div className="border-l border_gray_300"></div>
            <div>Any Week</div>
            <div className="border-l border_gray_300"></div>
            <div>Add Guests</div>
